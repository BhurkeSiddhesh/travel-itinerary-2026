...
- **2026-05-19**: Removed any giveaway mention of "The Tamara Coorg" from the Day 2 TL;DR text, stay pill, and pre-trip checklist sections to ensure the romantic dinner remains a complete mystery until unlocked. Left the gorgeous `heart` duck stickers inside these components fully active.
