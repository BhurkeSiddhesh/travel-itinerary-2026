...
# 1. Update Title and Headers (handle both hyphens and em-dashes)
html = re.sub(r'<title>Coorg.*?Mysuru.*?Ooty.*?</title>', '<title>Coorg · Nagarhole Safari · Ooty — May 2026</title>', html)
html = re.sub(r'<div class="mobile-brand">Coorg.*?Mysuru.*?Ooty</div>', '<div class="mobile-brand">Coorg · Nagarhole Safari · Ooty</div>', html)
html = re.sub(r'<div class="trip-name">Coorg.*?Mysuru<br>Ooty Circuit</div>', '<div class="trip-name">Coorg · Nagarhole Safari<br>Ooty Circuit</div>', html)

# 2. Update Sidebar
sidebar_old = r"""      <a href="#day4" class="nav-link">\s*<span class="day-num">4</span>\s*<div class="nav-text">\s*<strong>Saturday, May 23</strong>\s*<span>Mysuru</span>\s*</div>\s*</a>\s*<a href="#day5" class="nav-link">\s*<span class="day-num">5</span>\s*<div class="nav-text">\s*<strong>Sunday, May 24</strong>\s*<span>Mysuru Full Day</span>\s*</div>\s*</a>\s*<a href="#day6" class="nav-link">\s*<span class="day-num">6</span>\s*<div class="nav-text">\s*<strong>Monday, May 25</strong>\s*<span>Transit to Ooty</span>\s*</div>\s*</a>"""
...
route_old = r"""        <div class="circuit-route">\s*<span class="circuit-stop">Mumbai</span>\s*<span class="circuit-dot"></span>\s*<span class="circuit-stop">Coorg</span>\s*<span class="circuit-dot"></span>\s*<span class="circuit-stop">Mysuru</span>\s*<span class="circuit-dot"></span>\s*<span class="circuit-stop">Ooty</span>\s*<span class="circuit-dot"></span>\s*<span class="circuit-stop">Mumbai</span>\s*</div>"""
...
html = re.sub(route_old, route_new, html)
...
# 5. Flight info
html = re.sub(r'(<label for="c1"><strong>Flights \(MUM ✈ CJB\)</strong><span>Outbound May 20, Return May 27.)(.*?)(</span></label>)', 
              r'\1 IndiGo PNR: 0405260074543. See <code>tickets-bookings/Flight_ETicket_0405260074543.pdf</code>\3', html)
...
# Save using utf-8-sig to ensure BOM is added (fixes Windows browser rendering)
with open('index.html', 'w', encoding='utf-8-sig') as f:
    f.write(html)
print("Regex Rebuilt Nagarhole itinerary cleanly with UTF-8 BOM!")
